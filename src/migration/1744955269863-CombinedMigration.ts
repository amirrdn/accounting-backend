...
export class CombinedMigration1744955269863 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE IF EXISTS purchase_receipt_item`);
        await queryRunner.query(`DROP TABLE IF EXISTS purchase_receipt`);
        await queryRunner.query(`DROP TABLE IF EXISTS purchase_payment`);
        await queryRunner.query(`DROP TABLE IF EXISTS purchase_invoice_item`);
        await queryRunner.query(`DROP TABLE IF EXISTS purchase_invoice`);
