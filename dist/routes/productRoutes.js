...
const getAllHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield ProductController_1.ProductController.getAll(req, res);
});
const getByIdHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield ProductController_1.ProductController.getById(req, res);
});
const createHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield ProductController_1.ProductController.create(req, res);
});
const updateHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield ProductController_1.ProductController.update(req, res);
});
const deleteHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield ProductController_1.ProductController.delete(req, res);
});
router.get("/", getAllHandler);
router.get("/:id", getByIdHandler);
router.post("/", (0, role_1.authorize)("admin", "inventory"), createHandler);
router.patch("/:id", (0, role_1.authorize)("admin", "inventory"), updateHandler);
