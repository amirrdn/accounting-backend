...
const getAllHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield JournalEntryController_1.JournalEntryController.getAll(req, res);
});
const getByIdHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield JournalEntryController_1.JournalEntryController.getById(req, res);
});
const createHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield JournalEntryController_1.JournalEntryController.create(req, res);
});
const updateHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield JournalEntryController_1.JournalEntryController.update(req, res);
});
const deleteHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield JournalEntryController_1.JournalEntryController.delete(req, res);
});
router.get("/", getAllHandler);
router.get("/:id", getByIdHandler);
router.post("/", (0, role_1.authorize)("admin", "accounting"), createHandler);
router.put("/:id", (0, role_1.authorize)("admin", "accounting"), updateHandler);
