...
const getAllHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield SalesInvoiceController_1.SalesInvoiceController.getAll(req, res);
});
const getByIdHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield SalesInvoiceController_1.SalesInvoiceController.getById(req, res);
});
const createHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield SalesInvoiceController_1.SalesInvoiceController.create(req, res);
});
const updateHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield SalesInvoiceController_1.SalesInvoiceController.update(req, res);
});
const deleteHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield SalesInvoiceController_1.SalesInvoiceController.delete(req, res);
});
