...
const getAllHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield AccountController_1.AccountController.getAll(req, res);
});
const getByIdHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield AccountController_1.AccountController.getById(req, res);
});
const createHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield AccountController_1.AccountController.create(req, res);
});
const updateHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield AccountController_1.AccountController.update(req, res);
});
const deleteHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield AccountController_1.AccountController.delete(req, res);
});
router.get("/", getAllHandler);
router.get("/:id", getByIdHandler);
router.post("/", (0, role_1.authorize)("admin", "accountant"), createHandler);
router.put("/:id", (0, role_1.authorize)("admin", "accountant"), updateHandler);
